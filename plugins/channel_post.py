...
from plugins.link_generator import get_shortlink
...
async def channel_post(client: Client, message: Message):
    ...
    await reply_text.edit(f"<b>Here are your links\n\nLink: </b>{link} \n\n<b>Slink : </b>{slink}", reply_markup=reply_markup, disable_web_page_preview = True)
